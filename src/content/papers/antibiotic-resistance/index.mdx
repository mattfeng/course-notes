...
- some antibiotics don't work against metabolically-repressed (starving) bacteria

## Eradicating bacterial persisters with combinations of strongly and weakly metabolism-dependent antibiotics
- **bacterial persisters**. cells that survive antibiotic treatment despite lacking genetically encoded antibiotic resistance determinants
- metabolism-dependent classes
  - **beta-lactam**: ampicillin
  - **quinolone**: ciprofloxacin
  - **aminoglycoside**: gentamicin
- use cell media richness to control metabolic state (repressed or active)
  - 100%, 10%, 1% LB
- **bacteriostatic agent (bacteriostat, bstatic).** a biological or chemical agent that stops bacteria from reproducing, while not necessarily killing them otherwise
  - e.g. chloramphenicol
