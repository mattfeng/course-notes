...
- Would it be feasible to create a change agent like DARPA for other legacy sectors, such as infrastructure? What different pressures would such a change agent face?
    - Who would mandate implementation? For example, building infrastructure; does the federal government have this authority?
- How do we think about and resolve the inefficencies in the procurement stage?
    - Innovation in project delays and cost overruns?
...
- Why are innovators like Bush, Licklider, and Sutherland ignored in popular culture compared to that of Gates and Jobs? What does this say about how we view research contributions?
...
## lecture notes
- class 1: innovation-based growth model
    - factor 1: research and development
    - factor 2: human capital engaged in research
- class 2: innovation system
    - factor 3: national systems of innovation
    - innovation-based growth theory should be supplanted with _windows of opportunity_
- class 3: federal innovation system organization
    - distributed science (instead of central science authority) has its pros and cons
        - pros: more chances
        - cons: hard to collaborate
- class 4: crossing the valley of death
    - ruttan: defense department is running the connected model
        - lots of results: aviation, electronics, space, internet
    - discussion of the different models
- class 5: innovation at the face-to-face level: _great groups_
- class 6: _combining institutional and great group innovation_

## Waldrop, _The Dream Machine_ (2001)
- original computing paradigm: mainframes; predetermined programs
- Licklider built his own cars
- Licklider at MIT studying psychology; psychology department gets shut down; Licklider moves to Lincoln Lab
    - development of SAGE (real time warning system)
- SAGE becomes IBM 700
- one of his great essays
    - _Libraries of the Future_
        - stores everything online, with search
- humans surpass machines in 
    - perception
    - goal-setting
    - judgment
    - insight
- Licklider's vision: _man-machine symbiosis_
    - personal desk console linked by phone lines
    - programming will be a whole science; will lead to _dynamic modeling_
- computers will be useful in social sciences because they can tackle complexity (multitude of variables)
- _bringing ideas to reality_
    - Licklider is the visionary
    - DARPA is a vision champion
- services take back defense space programs from DARPA
    - DARPA has lots of money and nothing to do
    - Jack Ruina hires Licklider
- Licklider is the pied piper
    - finding and attracting talent to DARPA
    - monthly meetings across teams
- DARPA has **Other Transactions Authority**
    - _research contracts_ are different from _weapons contracts_
- project manager is _very engaged_
- MIT Great Group - Project MAC (Multiple Access Computing)
    - two separate, competing computing approaches
        - interactive computing (project MAC)
        - computer thinking > human thinking (AI)
- DARPA adopts _email as killer app_

## carleton, _the value of vision in radical technological innovation_ (2010)
- process model, six stages
    - recruitment
    - vision formulation: must be &ldquo;DARPA hard&rdquo;
