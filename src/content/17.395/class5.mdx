...
![innovation mix in an innovation wave.](./assets/innovation-mix-in-innovation-wave.png)

- after the dominant design emerges, **category killers** emerge
- impact on DEC: _cost_ and _openness_
- because DEC built its business model and culture around the time-shared paradigm and became a leader, it was difficult for DEC to cannabalize its own market by launching a competitive product in the new, client-server paradigm.

### chapter 10. the impact of success, growth, and age
- **growth** and **age** _inevitably_ erose core elements of the culture

#### stage 1: DEC as a young, small, cohesive family
- product managers had to fight one another for time and attention from central services such as sales and manufacturing
- _commitment to open communication and problem solving rather than assigning blame_
    - the fact that budgets and schedules might not be met was considered normal and _did not matter because the level of growth and the success of products remained high_
- problems
    - _effective presentation and interaction skills were not high priorities_; this led to wasteful, distracted, and unproductive meetings
    - later on in dec's growth, the lack of functional familiarity was evidenced by the &ldquo;DEC nod,&rdquo; i.e. polite agreement without actual **buy-in**

#### stage 2: with success and growth, DEC becomes a &ldquo;coat of many colors&rdquo;

- major consequences of growth and aging
    - **_loss of functional familiarity._**
    - _loss of personal, f2f management._
    - _increasing differentiation._
    - _growth of subunits and subcultures._
        - subcultures may not be aligned with the larger organization's culture
        - loyalty shifts away from the total organization to the subunit
    - _coordination mechanisms change._
    - _measurement mechanisms change._
    - _strategic focus becomes more difficult._
    - _the nature of accountability changes._
        - manager explanations don't work; metrics must be met
    - _the role of functions and central services changes._
    - _maintaining a common culture becomes more difficult._
    - _growth of responsibility for self and others increases._
        - youthful exuberance subsides as the organization becomes more accountable
    - _self-confidence (arrogance) grows._
    - _the family becomes a clan and eventually, a community or society._
    - _the core technology evolves._
    - _cost pressures increase._
    - _product innovation is increasingly replaced by process innovation._
    - _the nature of leadership changes._
        - leadership becomes more distributed, and fewer employees personally know the leaders
- invisible consequences
    - in a larger organization, central priorities need to be set
        - otherwise, different groups begin to see debates as fights to protect their turf
    - empowerment meant successive subunits developed their own strategic agendas and subcultures
    - succession issues become sensitive

## sir harold evans, _they made america_ (2004)

### edison
- although edison portrayed himself as a tinkerer, in reality he had a strong understanding of science
