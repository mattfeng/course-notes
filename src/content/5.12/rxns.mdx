...
- Van Vranken
  ...
  - methyl iodide is a liquid
    - methyl bromide and methyl chloride are gases
...
## Unit 2 reactions (alkenes, alkynes)

### Alkenes

<Box>

#### Preparation of epoxides with peroxyacids (mCPBA) (`klein, 13.8`)

- **stereospecific**

![Epoxidation.](./assets/rxns/epoxidation.png)
...
#### Catalytic hydrogenation <T tag="from alkene to alkane" />
- **_syn_-addition**
...
#### Halohydrin formation <T tag="unit2" />
- **_anti_-addition** via bromonium ion intermediate
...
![anti-dihydroxylation mechanism.](./assets/rxns/anti-dihydroxylation-mxn.png)
...
#### Hydroboration-oxidation: anti-mknv addition of <C chem="\ce{OH}" /> yielding _aldehydes_ from terminal alkynes

- internal alkynes: regiochemistry doesn't matter

![Alkyne hydroboration-oxidation.](./assets/rxns/alkyne-hydroboration.png)

![Base-catalyzed tautomerization.](./assets/rxns/base-cat-tautomerization.png)
...
#### Reduction of alkynes to _cis_ alkenes with Lindlar's catalyst <T tag="unit2" />

#### Reduction of alkynes to _trans_ alkenes with _dissolving metal reduction_ <T tag="unit2" />

![Dissolving metal reaction.](./assets/rxns/dissolving-metal.png)

![Dissolving metal reaction mechanism.](./assets/rxns/dissolving-metal-mxn.png)
...
#### Acetylide ion formation (`L17`) <T tag="carbon-carbon" />

![Acetylide ion formation.](./assets/rxns/acetylide-ion.png)
...
- **NBS** helps avoid competition with alkene bromination
  - concentrations of <C chem="\ce{HBr}" /> and <C chem="\ce{Br2}" /> are kept to a minimum
...
#### Catalytic hydrogenation of aryl ketones <T tag="aryl" /> <T tag="from ket" /> (`L33,3`)
...
![Formation of better leaving group](./assets/rxns/roh-pbr3-mxn.png)
...
#### With thionyl chloride (<C chem="\ce{SOCl2}" />), pyridine (`L23`) <T tag="from alcohol to alkyl halide" /> <T tag="better LG" />

- **inversion of configuration**

![Formation of better leaving group with SOCl2 and pyridine.](./assets/rxns/roh-socl2-mxn.png)

</Box>

<Box>

#### With tosyl chloride and pyridine (<C chem="\ce{TsCl, py}" />) (`L23`) <T tag="from alcohol to alkyl halide" />

- can be used to add almost any <C chem="\ce{X}" />
- **retention of configuration**

![Formation of better leaving group with TsCl and NaX.](./assets/rxns/roh-tscl-mxn.png)
...
#### Oxidation of 1º alcohol (Jones oxidation) <T tag="from alcohol to carboxylic acid" />
...
![Jones oxidation.](./assets/rxns/jones.png)

</Box>

<Box>

#### Oxidation of aldehyde (Jones oxidation) <T tag="from aldehyde to carboxylic acid" />
...
#### Via DCC (dicyclohexylcarbodiimide) (aka peptide bond synthesis) (`L29`) <T tag="from carboxylic acid to amide" />
...
#### Reverse of Fischer esterification (acat hydrolysis) (`klein, 20.11`/`L28,6`) <T tag="from ester to carboxylic acid" />
...
#### Preparation of acyl chlorides via thionyl chloride (<C chem="\ce{SOCl2}" />) (`klein, 20.8`/`L28`) <T tag="from carboxylic acid to acyl chloride" />

- formation of <C chem="\ce{SO2}" /> gas drives reaction to completion

![Carboxylic acid becomes acid chloride via SOCl2.](./assets/rxns/socl2-acid-chloride.png)

![Mechanism for acid chloride formation.](./assets/rxns/cooh-socl2-mxn.png)
...
- two equivalents of <C chem="\ce{R^1R^2NH}" /> are used.
  ...
  - or just use **pyridine** or <C chem="\ce{Et3N}" />
...
- **limitations**
  - **aryl bromines** will be removed (`51c`)
...
- common strong, **non-nucleophilic** bases (for complete deprotonation of alpha hydrogen)
  - LDA
  - LiHMDS
  - LiTMP
  - NaH
...
## Aldol reactions (`51c,l18,25:33`)

- **using enolates as nucleophiles**
- generally use **alkoxide** or **hydroxide** base; LDA can be used but its very time consuming in practice

<Box>

#### Aldol addition (`klein, 21.3`/`L31`) <T tag="from ket" /> <T tag="from ald" />
...
![Aldol addition.](./assets/rxns/aldol-addn.png)

![Aldol addition mechanism.](./assets/rxns/aldol-addn-mxn.png)

![Aldol addition alternative mechanism (different resonance form shown, mechanism is actually the same).](./assets/rxns/aldol-addn-alt-mxn.png)

</Box>

<Box>

#### Aldol condensation (`klein`/`L31`)

![Aldol condensation mechanism (both acid and base promoted).](./assets/rxns/aldol-condensation-mxn.png)

- note that the basic mechanism is **not concerted**
- **addition vs. condensation?**
  - if $\alpha,\beta$-unsaturated product is conjugated (beyond the dienone that is always formed), **condensation is spontaneous**
  - if heat, **condensation**
...
- **key**: need an **aldehyde** without $\alpha$-hydrogens
  - **aldehyde** used so that it is attacked quickly
- enolate doesn't attack the **ketone** because its slower (sterics)
- common **aldehydes**
  - formaldehyde
  - [pivaldehyde](https://en.wikipedia.org/wiki/Pivaldehyde)
  - benzyaldehyde
  - enone
- 1,3-dicarbonyls are highly effective in crossed aldol reactions as the **enolate**
...
- **_reagents_**
  - acyl chloride; **requires R group to at least be methyl** (`PS8`)
    - carbocation is too unstable without hyperconjugation
  - <C chem="\ce{AlCl3}" />
- **limitations**
  - cannot be done on **anything meta directed**
    - too **deactivated**
...
- DIBAL-H reduction
  - ester to aldehyde
  - nitrile to aldehyde
- LDA: forms enols/enolates
  - remove $\alpha$-hydrogen

### Conformations
- E2 reactions only occur when the **leaving group is axial**

---

## &ldquo;after class slides&rdquo;

<Box>

#### <T tag="30.7-8" /> Types of bases
- sodium ethoxide (<C chem="\ce{NaOEt}" />) can deprotonate 1,3-dicarbonyls
  - only tiny amounts of carbonyls on the **more substituted side**
- LDA is deprotonates alpha hydrogens on the **less substituted side**

</Box>

<Box>

#### <T tag="klein, 7.8" /> Zaitsev's rule
- more substituted alkene is more likely to form in E2 reactions unless the **base is sterically hindered**
...
#### Sodium hydride: <C chem="\ce{NaH}" />

- used in making **epoxides**
- **bad for E2 reactions**
