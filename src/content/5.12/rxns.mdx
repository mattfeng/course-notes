...
#### Adding carbonyl groups (form carbon-carbon bond)
...
#### Sulfonation (form carbon-sulfur bond) (less useful)
...
#### Alkylation (form carbon-carbon bond) (less useful)
- **_reagents_**
  - <C chem="\ce{R-X}" />
  - <C chem="\ce{AlCl3}" />
