...
### Alcohol <RA /> Alkyl halide

#### <Rxn /> with <C chem="\ce{H-X}" />

#### <Rxn /> with <C chem="\ce{PBr3}" />

#### <Rxn /> with <C chem="\ce{SOCl2}" />, pyridine
...
#### Ester reduction with DIBAL-H (_aldehyde only_) (`kakioka, WS_11_16`)
...
### Ketone <RA /> cyanohydrin

#### <Rxn /> Cyanohydrin formation
