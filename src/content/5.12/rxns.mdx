...
#### <Rxn /> Grignard reagent with <C chem="\ce{CO2}" />
...
#### <Rxn /> Acyl chloride <RA /> carboxylic acid (`klein, 20.8`/`L28`)
...
#### <Rxn /> Nitrile <RA /> carboxylic acid (`klein, 20.4`)
...
#### <Rxn /> Fischer esterification (`klein, 20.10`/`L28,6`)
