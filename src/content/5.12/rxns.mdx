...
#### <Rxn /> 1º alcohol <RA /> carboxylic acid

- **_reagents_**
  - chromium trioxide (<C chem="\ce{CrO3}" />)
  - strong acid (<C chem="\ce{H3O+}" />)

#### <Rxn /> Aldehyde (two hydrogens) <RA /> carboxylic acid
...
### Carboxylic acid <RA /> acyl chloride

#### <Rxn /> via tionyl chloride (<C chem="\ce{SOCl2}" />) (`klein, 20.8`/`L28`)
