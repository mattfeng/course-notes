...
#### Reduction of nitro groups to amines (`51c,l2,16:27`) <T tag="from nitro to amine" />
...
#### Reduction of amides to amines (`smith5e, 20.7B`/`L29.3`)
...
#### Wolff-Kishner reaction: reduce ald/ket to alkane (`L27`/`klein, 19.6`)
