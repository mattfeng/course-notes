...
#### Oxidation in the presence of benzylic hydrogen
...
#### Ester reduction with DIBAL-H (_aldehyde only_) (`kakioka, WS_11_16`) <Nmxn />
...
#### Reduction of nitriles with DIBAL (`L25`) <Nmxn />
...
#### Reduction of nitriles with <C chem="\ce{LiAlH4}" /> (`L28`)
