...
## Key points
- The R state of Hb is called **oxyhemoglobin**, even if no oxygen is bound.
- The KNF (sequential) model can explain **negative cooperativity**.
  - The MWC model cannot explain negative cooperativity because we already start in the lowest affinity state.
