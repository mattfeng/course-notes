...
- Why are synthetic proteins important?
    1. synthetic peptides can serve as antigens to stimulate the formation of specific antibodies
    2. synthetic peptides can be used to isolate receptors for many hormones and signal molecules
    3. synthetic peptides can serve as drugs
        - synthetic vasopressin
    4. studying synthetic peptides can help define the rules governing the three-dimensional structure of proteins
- Solid-phase synthesis method has been used to make peptides of **50 amino acids**
    1. link carboxyl to resin
    2. repeat
        - deprotect amino acid
        - bring in next amino acid (protected form)
        - react with DCC
...
- [Why is arginine easy to protonate?](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4420524/)
  - **Arginine is basic because its protonated form is stable (stabilized by resonance).**
  - If any of the other nitrogens were protonated, they wouldn't have resonance stabilization, so they are less good as bases.

![Arginine, protonated and unprotonated.](./arginine.jpg)