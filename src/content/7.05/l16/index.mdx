...
- **aggrecan**
  ...
  - glycosaminoglycan attachment between domains 2 and 3
  - aggrecans are also bound to **hyaluronate** (a glycosaminoglycan)
  - water binds to **glycosaminoglycans**
    - **osteoarthritis** results when water is lost from proteoglycan

![Aggregan attached to hyaluronate.](./aggregan.png)

![Proteoglycans in cartilage.](./cartilage.png)

#### Mucins are glycoprotein components of mucus
- defining feature of mucins: region of protein backbone known as **variable number of tandem repeats (VNTR)**
  - rich in serine and threonine residues that are O-glycosylated

![Structure of a mucin.](./mucin.png)

- <D/> and Cys-rich regions facilitate polymerization
- mucins are overexpressed in **adenocarcinomas**: cancers of the glandular cells of epithelial origin
- mucins involved in 
  - protective barrier: stomach acid, inhaled chemicals, bacterial infections
  - hydrating underlying cells
  - fertilization
  - immune response
  - cell adhesion
