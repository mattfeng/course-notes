...
### Key points
1. GTPase cycle
2. Arg finger mechanism of GAPs
3. Scatchard plot
4. Nucleotides, nucleosides, and base structures
5. B-form DNA
6. Major groove vs. minor groove
7. Nucleic acid melting and cooperativity

### GTPase cycle
- GTP exchange factors <T tag="test" />
- GTPase activator protein (GAP)

### Nucleotides, nucleosides, and bases
- **nucleotide**. base + sugar + phosphates ($\alpha$, $\beta$, $\gamma$)
- **nucleoside**. base + sugar

### B form DNA
- DNA fibers in environment:
  - 92% humidity
  - alkali metal ($\ce{Na+}$)
- **keto form**
- helix is stabilized by **$\pi-\pi$ stacking** (dominant force), VDW interactions, and hydrophobic forces (entropy)

#### Key facts of the Watson-Crick model
1. double helix
2. right handed twist
3. antiparallel chains
4. helix dimensions
  - 34 Å per helical turn
  - 20 Å diameter
  - 10 bp per turn $\implies$ 3.4 Å rise/bp
5. bases are on the inside
6. backbone is on the outside
  - negatively charged backbone keeps nucleophiles away
7. two grooves
  - **major groove**.
  - **minor groove**.
8. bases bind to each other via hydrogen bonds
- For G:C and A:T base pairs, the distance between **C1' carbons is always 11 Å**
  - **a fixed backbone can tolerate any sequence of A:T and G:C pairs**
  - G:C and A:T base pairs are **isosteric**

### Major and minor grooves
- we can "read" the sequence using the H-bond donor and acceptor patterns in the major grooves
  - AT: acceptor, donor, acceptor
  - GC: acceptor, acceptor, donor
- **doesn't work for the minor groove**
  - both: acceptor, donor, acceptor
- minor groove: nonspecific binding
- major groove: specific binding
- **transcription factors need to have side chains that can make hydrogen bonds**
- nucleotides essentially have all their chemistry used
