...
- necessary because both carbonic acid and carbon dioxide are susbtrates for many enzymes

#### Carbonic anhydrase contains a bound zinc ion essential for catalytic activity
- humans have at least seven distinct carbonic anhydrases (each with own gene)
- **carbonic anhydrase II (CAII)**
  - major component of RBCs
  - one of the most active CAs
- Zn is coordinated with neutral molecules, so entire complex has +2 charge.

#### Catalysis entails zinc activation of a water molecule
- pKa of **zinc-bound water** is 7.

![pKa of zinc-bound water.](./zn-h2o.png)

![Mechanism of carbonic anhydrase.](./carbonic-anhydrase-mxn.png)

- acid/base catalysis
- transition state stabilization
- approximating water and carbon dioxide

#### A proton shuffle facilitates rapid regeneration of the active form of the enzyme
- diffusion limit would only allow a max rate of $\pu{10^4 s-1}$; rate is actually $\pu{10^6 s-1}$
- how? use of buffer
  - if pKa of buffer is same as pKa of zinc-bound water, then equilibrium constant of acid/base reaction is 1.
- His64 deprotonates zinc-bound water and is deprotonated by the buffer.

### 16.1; Mechanism: Triose phosphate isomerase (TPI) salvages a three-carbon fragment

![Reaction catalyzed by TPI.](./tpi-rxn.png)

![Mechanism of triose phosphate isomerase.](./tpi-mxn.png)

- TPI is noteworthy because
  1. great catalytic ability (**kinetic perfection**)
  2. suppresses undesired side reaction (decomposition of enediol into methyl glyoxal and orthophosphate)
    - **methyl glyoxal** can form harmful **advanced glycation end products**
