...
### Basic immunology of the SARS-CoV-2

![Basics of coronavirus.](./coronavirus.jpg)

![Basic immunology crash course.](./immune.jpg)

- Which cells are producing the spike protein?
    - Any cell that takes up that liposome; the mRNA has a sequence code
    - Moderna is membrane-bound (cells that produce the spike adds it to its membrane)
        - because the proteins are being synthesized, some are destroyed and then presented on the cell
    - BioNTech is not membrane-bound (exported)
- Dendritic cells can take both the coronavirus **wholesale** or just the **spike protein** (they are vacuum cleaners).

- Immune strategy 1: **activate B cells** (MHC Class II Vaccine)
- Immune strategy 2: **create many CD8+ T cells** (MHC Class I Vaccine)
    - take pieces of viral protein that don't drift
    - we can use the **internal proteins** because infected cells produce the entire virus

- We need $n > 1$ because we need redundancy.
    - Redundancy in the model's predictions; peptide predicted coverage might not be correct.
    - The whole purpose is to avoid vaccine escape through drift.