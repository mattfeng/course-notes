...
## Lecture: Using computational methods to address druggability and drug discovery challenges
- water contains the information for ligand design
- rethinking SBDD: simulate, emulate water
- hidden cavities are imprints of **protein flexibility**
  - e.g. 3WST; 18 copies in asymmetric unit
    - N-methyltransferase 7 (PRMT7)
  - $\ce{t-Bu}$ keeps protein in active state because waters are pushed out of the way
- hide polarity using cyclization