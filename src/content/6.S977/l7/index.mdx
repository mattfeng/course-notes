...
- Databases
  - `ExCAPE-DB`
- Key challenge for medicinal chemists: **what to make and test next?**
- synthesis paradigms
  - **diversity-oriented synthesis (DOS)**. generate molecules with diverse functional groups
  - **biology-oriented synthesis (BIOS)**. use natural products are templates for derivatives
  - **function-oriented synthesis (FOS)**. replicate the function of biological active structures to obtain simpler scaffolds
    - example: caprazamycin $\to$ oxazolidine derivatives

---

## Lecture notes
- NIBR increasingly screens on organoids