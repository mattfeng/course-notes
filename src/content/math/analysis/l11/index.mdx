...
**Theorem 1.** Finite sets are compact.
...
**Theorem 2.** Compact sets are **bounded**.
...
**Theorem 3.** Suppose $E \subset Y \subset X$. Then $E$ is open in $Y$ iff $E = Y \cap G$ for some open $G$ in $X$.
