...
- **modeling the problem**
  - behavioral models
  - essentially, a **causal model** for why the problem exists

##### P2<SPACE />Choosing and explaining relevant goals and constraints
- need to be **normative**; need to decide what **should** be wanted
  - this is the most difficult part: specifying an overt value system
...
- other kinds of goals fall into two categories
  ...
  - **instrumental**. conditions that increase the prospects for achieving substantive goals
...
- **clarifying trade-offs between goals**
  - weights placed on goals often is an output, rather than input, of policy analysis
- **clarifying the distinction between goals and policies**
  - **goals**. the values we seek to promot
  - **policies**. the alternatives and strategies for promoting our values

##### P3<SPACE />Selecting a solution method
- only efficiency: **cost-benefit analysis**
- efficiency and one other goal: **cost-effectiveness analysis**
- efficiency and multiple goals: **multi-goal analysis**
- **cost-benefit analysis**
  - requires _monetization_ of everything
- **qualitative cost-benefit analysis**.
  - when not everything can be monetized
  - need to argue order of magnitude value
- **modified cost-benefit analysis**. maximize goal while minimizing deadweight loss

#### Solution analysis
- Essentially create a 2 dimensional grid: policies vs. values
